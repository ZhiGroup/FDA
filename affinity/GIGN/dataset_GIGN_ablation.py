...
def mols2graphs(complex_path, label, save_path, dis_threshold=5.):
    try:
        ...
        print(f"Unable to process {complex_path}, error: {e}")
        return None
    # return data
...
class GraphDataset(Dataset):
    ...
    def _pre_process(self):
        ...
        self.graph_paths = [graph_path for graph_path in graph_path_list if os.path.exists(graph_path)]
...
if __name__ == '__main__':
    ...
    data_root = '/data/mwu11/DiffDock/data/PDBBind2016'
